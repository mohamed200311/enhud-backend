...
try:
    ...
    print("Loading base model 'google/flan-t5-large'...")
    base_model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-large")
    print("Base model loaded.")

    print("Loading PeftModel...")
    model = PeftModel.from_pretrained(base_model, "lorahub/flan_t5_large-social_i_qa_Generate_the_question_from_the_answer")
    ...
    distractor_pipeline = pipeline("text2text-generation", model="google/flan-t5-large", tokenizer=tokenizer)
